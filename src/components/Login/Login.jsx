...
function Login(props, ref) {
    ...
    // Form gönderildikten sonra sisteme giriş yapmak için gerekli fonksiyon tanımlanıyor.
    ...
    return (
        // Login bileşeni tanımlanıyor. Gerekli referans tanımlanıyor.
        <section ref={ref} id='login' className='login z-30 hidden fixed -translate-y-full top-0 w-full min-h-full -ml-[2vw] flex flex-col justify-center items-center' {...props}>
            <form 
            ...
            >
                <h1 className='m-auto text-4xl font-medium mb-6'>LOGIN</h1>
